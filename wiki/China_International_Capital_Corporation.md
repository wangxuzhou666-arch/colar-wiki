...
subtitle: Investment banking internship of Colar Wang (2023)
  ...
  rows:
    - label: Employer
      value: |
        ...
        Corporation (CICC, 中金公司)
    - label: Role
      value: Investment Bank Intern
    - label: Location
      value: Shanghai, China
    - label: Dates
      value: June 2023 – July 2023
    - label: Focus
      value: |
...
Wang conducted quantitative market analysis of the semiconductor
industry using the **Wind Financial Terminal**, with the goal of
identifying trends relevant to the firm's coverage and strategy
recommendations. The assignment was Wang's first exposure to the
use of professional terminal-based financial tooling and to the
sell-side research workflow.

### IPO prospectus support

Wang additionally supported the preparation and delivery of initial
public offering (IPO) prospectus documentation, including data
validation and the production of analytical documentation for
internal review.
